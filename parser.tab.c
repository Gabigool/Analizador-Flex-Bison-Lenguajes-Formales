...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_lista_reglas = 25,              /* lista_reglas  */
  YYSYMBOL_access_rule = 26,               /* access_rule  */
  YYSYMBOL_user_clause = 27,               /* user_clause  */
  YYSYMBOL_role_type = 28,                 /* role_type  */
  YYSYMBOL_logical_expression = 29,        /* logical_expression  */
  YYSYMBOL_condition = 30,                 /* condition  */
  YYSYMBOL_time_condition = 31,            /* time_condition  */
  YYSYMBOL_resource_condition = 32,        /* resource_condition  */
  YYSYMBOL_custom_condition = 33,          /* custom_condition  */
...
{
       0,    85,    85,    86,    97,   100,   112,   124,   125,   126,
     133,   134,   137,   140,   143,   157,   158,   159,   170,   173,
     186,   189,   201,   215,   216,   217,   232,   233,   234,   235,
     236,   237
};
#endif
...
static const char *const yytname[] =
{
  ...
  "lista_reglas", "access_rule", "user_clause", "role_type",
  "logical_expression", "condition", "time_condition",
...
{
       3,    24,     5,   -16,    26,   -16,   -16,   -16,   -16,   -16,
     -16,    -5,     9,     9,     9,    -5,    -5,     9,     6,   -16,
     -16,   -16,   -16,   -16,   -16,   -16,   -16,   -16,   -16,    -8,
      15,    12,   -16,    -1,    10,    -5,    -5,   -16,   -16,   -16,
...
{
       0,     0,     0,     3,     5,     7,     8,     9,     6,     1,
       2,     0,     0,     0,     0,     0,     0,     0,     4,    10,
      15,    16,    17,    26,    27,    28,    29,    30,    31,     0,
       0,     0,    13,     0,     0,     0,     0,    18,    19,    20,
      21,    14,    23,    24,    25,    22,    12,    11
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -16,   -16,    37,   -16,   -16,   -15,   -16,   -16,   -16,   -16,
     -16,    -2
};
...
{
      32,    33,    12,    13,    14,     9,     1,    15,     1,    35,
      36,    30,    31,    37,    16,    34,    35,    36,    17,    41,
      46,    47,    23,    24,    25,    26,    27,    28,     5,     6,
       7,    42,    43,    44,    39,    40,    11,    38,    35,    10
};

static const yytype_int8 yycheck[] =
{
      15,    16,     7,     8,     9,     0,     3,    12,     3,    10,
      11,    13,    14,    21,    19,    17,    10,    11,    23,    20,
      35,    36,    13,    14,    15,    16,    17,    18,     4,     5,
       6,    21,    22,    23,    22,    23,    10,    22,    10,     2
};
...
{
       0,     3,    25,    26,    27,     4,     5,     6,    28,     0,
      26,    10,     7,     8,     9,    12,    19,    23,    29,    30,
      31,    32,    33,    13,    14,    15,    16,    17,    18,    35,
      35,    35,    29,    29,    35,    10,    11,    21,    22,    22,
      23,    20,    21,    22,    23,    34,    29,    29
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* access_rule: user_clause AND logical_expression  */
#line 97 "parser.y"
                                        { 
...
#line 1135 "parser.tab.c"
  ...
  case 5: /* access_rule: user_clause  */
#line 100 "parser.y"
                                        { 
...
#line 1143 "parser.tab.c"
  ...
  case 6: /* user_clause: USER role_type  */
#line 112 "parser.y"
                                        { 
...
#line 1151 "parser.tab.c"
  ...
  case 7: /* role_type: ADMIN  */
#line 124 "parser.y"
                                        { (yyval.string) = "admin"; }
#line 1157 "parser.tab.c"
    break;

  case 8: /* role_type: GUEST  */
#line 125 "parser.y"
                                        { (yyval.string) = "guest"; }
#line 1163 "parser.tab.c"
    break;

  case 9: /* role_type: OPERATOR  */
#line 126 "parser.y"
                                        { (yyval.string) = "operator"; }
#line 1169 "parser.tab.c"
    break;

  case 11: /* logical_expression: logical_expression OR logical_expression  */
#line 134 "parser.y"
                                               { 
...
#line 1177 "parser.tab.c"
  ...
  case 12: /* logical_expression: logical_expression AND logical_expression  */
#line 137 "parser.y"
                                                { 
...
#line 1185 "parser.tab.c"
  ...
  case 13: /* logical_expression: NOT logical_expression  */
#line 140 "parser.y"
                             { 
...
#line 1193 "parser.tab.c"
  ...
  case 14: /* logical_expression: LPAREN logical_expression RPAREN  */
#line 143 "parser.y"
                                       { 
